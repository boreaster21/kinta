...
<div class="request-list">
    ...
    <div class="request-list__tabs">
        <a href="{{ route('admin.stamp_correction_request.list', ['status' => 'pending']) }}" class="request-list__tab {{ $status === 'pending' ? 'request-list__tab--active' : '' }}">
            承認待ち
        </a>
        <a href="{{ route('admin.stamp_correction_request.list', ['status' => 'processed']) }}" class="request-list__tab {{ $status === 'processed' ? 'request-list__tab--active' : '' }}">
            処理済み
        </a>
    </div>
        ...
        <table class="request-list__table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ $request['detail_url'] }}" class="request-list__detail-link">詳細</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
